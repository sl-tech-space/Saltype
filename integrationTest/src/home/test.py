...
class TestHomePage:
    ...
    def test_home2(self):
        ...
        try:
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番2", "ホーム画面スタートボタン押下前"
            )
        ...
        try:
            ...
            next_button = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (By.CSS_SELECTOR, ".difficulty-setting .embla__next")
                )
            )
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番3", "ホーム画面スタートボタン押下前"
            )
    ...
    def test_home4(self):
        ...
        try:
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番4", "ホーム画面スタートボタン押下前"
            )
    ...
    def test_home5(self):
        ...
        try:
            ...
            next_button = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (By.CSS_SELECTOR, ".language-setting .embla__next")
                )
            )
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番5", "ホーム画面スタートボタン押下前"
            )
    ...
    def test_home6(self):
        ...
        try:
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番6", "ホーム画面スタートボタン押下前"
            )
    ...
    def test_home7(self):
        ...
        try:
            ...
            SeleniumUtil.take_screenshot(
                driver, "home", "項番7", "ホーム画面スタートボタン押下前"
            )
    ...
    def test_home8(self):
        ...
        try:
            ...
            ranking_element = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (By.XPATH, "//ul[@class='menu-list']/li[1]/p")
                )
            )
    ...
    def test_home10(self):
        ...
        try:
            ...
            ranking_element = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (By.XPATH, "//ul[@class='menu-list']/li[3]/p")
                )
            )
